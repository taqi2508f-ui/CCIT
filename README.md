...
CCIT bundles phishing URL scanning, email spoofing detection, static malware analysis, live network/DNS monitoring, and a custom signature-matching engine into a single PySide6 desktop app — with HTML/JSON reporting and a plugin system for extending it.

> ⚠️ **Legal Notice:** CCIT is built **exclusively for ethical, defensive cybersecurity investigation**. Do not use it for unauthorized access, offensive operations, or any illegal purpose.
...
| ⚙️ **Settings** | Theme switching, scanner parameters, database management, offline mode |
